...
C<$results_ref = $index-E<gt>Search( \%point, \%options );>
...
C<$results_ref = $index-E<gt>SearchByBounds( \@bounds, \%options );>
...
C<$results_ref = $index-E<gt>Closest( \%point, $number_of_points_desired, \%options );>
...
C<$results_ref = $index-E<gt>Farthest( \%point, $number_of_points_desired, \%options );>
